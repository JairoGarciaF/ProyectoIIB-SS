...
const questions = ref([
    ...
    { id: "1", label: "Mira este interesante video y brinda un comentario", answer: "", answers: 1 }
]);
...
<template>
  <div class="mx-5 my-4 p-6 bg-white rounded-md shadow-md grid justify-items-center">
    <h3 class="font-bold text-2xl"><i class="fa-solid fa-money-bill-1-wave"></i>HORA DE VENDER</h3>
    <br>
    <!-- Put the video of Shark programm -->
    <iframe class="w-[100%] h-[625px]" src="https://www.youtube.com/embed/HAqdjFTKK-k?si=puxIcZWC8YromHb9" 
